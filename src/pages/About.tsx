      ...
      <main className="flex-grow pt-20">
          ...
          <div className="container-custom relative z-10">
            <div className="max-w-3xl mx-auto text-center opacity-0 animate-fade-in">
              ...
              <p className="text-xl text-muted-foreground">
                We're a collective of digital specialists committed to helping
                ambitious businesses achieve exceptional outcomes.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="glass-card p-8 max-w-xs text-center">
                        <h4 className="text-xl font-semibold mb-4">
                          Our <span className="text-[#7960be]">Vision</span>
                        </h4>
                        <p className="text-muted-foreground">
                          To redefine how businesses access premium technical
                          talent and digital services.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div>
                <h2 className="mb-6 opacity-0 animate-fade-in">
                  Our <span className="text-[#7960be]">Mission</span>
                </h2>
                <p className="text-lg mb-6 text-muted-foreground opacity-0 animate-fade-in animation-delay-100">
                  We exist to bridge the gap between exceptional talent and
                  ambitious companies, creating value through strategic
                  technical partnerships.
                </p>
                <p className="text-lg mb-8 text-muted-foreground opacity-0 animate-fade-in animation-delay-200">
                  Our approach combines deep technical expertise with a focus on
                  business outcomes, ensuring that every project delivers
                ...
                <ul className="space-y-4 opacity-0 animate-fade-in animation-delay-300">
                  <li className="flex items-start">
                    ...
                    <span>
                      Delivering premium quality without premium pricing
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-3 mt-1 text-primary">→</span>
                  ...
                  <li className="flex items-start">
                    <span className="mr-3 mt-1 text-primary">→</span>
                    <span>
                      Creating value through technical excellence and business
                      insight
                    </span>
                  </li>
                </ul>
        ...
        <section className="py-20 bg-gradient-to-b from-background to-secondary/10">
          <div className="container-custom text-center">
            <h2 className="mb-6 opacity-0 animate-fade-in">
              Partner With <span className="text-[#7960be]">Us</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10 opacity-0 animate-fade-in animation-delay-100">
              Ready to transform your digital capabilities with exceptional
              talent and strategic expertise?
            </p>
