    ...
    <div className="min-h-screen flex flex-col bg-[#F7FFF7] text-[#191919]">
      ...
      <main className="flex-grow pt-32">
        <div className="container-custom py-16 max-w-4xl">
          <h1 className="text-4xl font-bold mb-8 text-[#7960BE]">
            Terms & Conditions
          </h1>
          ...
          <section className="mb-8">
            <p>
              Please review our Terms & Conditions carefully. This page is under
              construction and will be updated soon with detailed information
