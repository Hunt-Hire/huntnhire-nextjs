        ...
        <div className="container-custom py-16 max-w-4xl">
          ...
          <div className="relative mb-12">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold mb-4 relative z-10 animate-slide-up">
              Hunt & Hire <span className="bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Privacy Policy</span>
            </h1>
          ...
          <div className="relative bg-gradient-to-b from-secondary/10 to-background rounded-xl p-8 shadow-lg border border-white/5 bg-[linear-gradient(to_right,#ffffff12_1px,transparent_1px),linear-gradient(to_bottom,#ffffff12_1px,transparent_1px)] bg-[size:24px_24px]">
            <section className="mb-8 opacity-0 animate-slide-up">
              <h2 className="text-2xl sm:text-3xl font-semibold mb-4">1. Introduction</h2>
            ...
            <section className="mb-8 opacity-0 animate-slide-up animation-delay-100">
              <h2 className="text-2xl sm:text-3xl font-semibold mb-4">2. Information We Collect</h2>
              ...
              <p className="mb-2 text-muted-foreground">We collect Personal Information when you:</p>
              <ul className="list-disc pl-6 mb-4 text-muted-foreground">
                {[
                  ...
                  <li key={index} className="opacity-0 animate-slide-up" style={{ animationDelay: `${(index + 1) * 100}ms` }}>
                    {item}
                  </li>
                ))}
              </ul>
              
              <p className="mb-2 text-muted-foreground">This information may include:</p>
              <ul className="list-disc pl-6 mb-4 text-muted-foreground">
                {[
                  'Your name',
                  'Your email address',
            ...
            <section className="mb-8 opacity-0 animate-slide-up animation-delay-200">
              <h2 className="text-2xl sm:text-3xl font-semibold mb-4">3. How We Use Your Information</h2>
              <p className="mb-2 text-muted-foreground">We use your Personal Information to:</p>
            ...
            <section className="mb-8 opacity-0 animate-slide-up animation-delay-300">
              <h2 className="text-2xl sm:text-3xl font-semibold mb-4">4. Disclosure of Your Information</h2>
              <p className="mb-2 text-muted-foreground">We may disclose your Personal Information to:</p>
              <ul className="list-disc pl-6 text-muted-foreground">
                {[
            ...
            <section className="mb-8 opacity-0 animate-slide-up animation-delay-400">
              <h2 className="text-2xl sm:text-3xl font-semibold mb-4">5. Data Security</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section className="mb-8 opacity-0 animate-slide-up animation-delay-500">
              <h2 className="text-2xl sm:text-3xl font-semibold mb-4">6. Your Privacy Rights</h2>
              <p className="mb-2 text-muted-foreground">You have the following rights regarding your Personal Information:</p>
              <ul className="list-disc pl-6 mb-4 text-muted-foreground">
                {[
              ...
              <p className="text-muted-foreground leading-relaxed">To exercise your privacy rights, please contact us using the information below.</p>
            </section>
            
            <section className="mb-8 opacity-0 animate-slide-up animation-delay-600">
              <h2 className="text-2xl sm:text-3xl font-semibold mb-4">7. Children's Privacy</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section className="mb-8 opacity-0 animate-slide-up animation-delay-700">
              <h2 className="text-2xl sm:text-3xl font-semibold mb-4">8. Links to Other Websites</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section className="mb-8 opacity-0 animate-slide-up animation-delay-800">
              <h2 className="text-2xl sm:text-3xl font-semibold mb-4">9. Changes to this Privacy Policy</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section className="mb-8 opacity-0 animate-slide-up animation-delay-900">
              <h2 className="text-2xl sm:text-3xl font-semibold mb-4">10. Contact Us</h2>
              <p className="text-muted-foreground leading-relaxed">
                If you have any questions about this Privacy Policy, please contact us at info@huntnhire.co.
              </p>
            </section>
            
            <p className="text-muted-foreground opacity-0 animate-slide-up animation-delay-1000">
