...
const Navbar = () => {
  ...
  const handleHowItWorksClick = () => {
    ...
    const section = document.querySelector("#calender");
    if (section) {
  ...
  const searchableContent = [
    {
      ...
      keywords: ["discovery call", "candidate", "recruiters"],
    },
    {
      title: "Our Roles",
      sectionId: "roles",
      keywords: ["marketing", "virtual assistant", "ppc"],
    },
    {
      title: "About",
      path: "/about",
  ...
  const handleSearchSubmit = (e: React.FormEvent) => {
    ...
    if (searchQuery.trim()) {
      ...
      const match = searchableContent.find(
        (item) =>
