...
const HowItWorks = () => {
  ...
  return (
    <section
      id="how-it-works"
      ref={sectionRef}
      className="section bg-gradient-to-b from-background to-primary/5 py-24
                  relative overflow-hidden "
    >
      <div className="container-custom relative z-10">
        {/* Header */}
        <div className="text-center mb-20">
          <div className="inline-block px-6 py-3 mb-4 rounded-md btn-primary shadow-lg">
          ...
          {steps.map((step, index) => (
            <AnimatedCard
              ...
              className={`relative flex flex-col items-center text-center p-6 rounded-xl
                bg-background/95 shadow-lg border border-white/5 transition-all duration-300 ${
                  activeStep === index
                    ? "scale-105 border-primary/30 shadow-primary/10"
                    : ""
                }`}
            >
              <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 w-12 h-12 rounded-full bg-[#7960be] text-white font-bold text-lg flex items-center justify-center shadow-md">
                {step.number}
              </div>
              <div className="w-20 h-20 rounded-full bg-[#7960be]/10 flex items-center justify-center mb-6 mt-6">
                {step.icon}
              </div>
              <h3 className="text-2xl font-extrabold text-[#7960be] mb-4">
                {step.title}
              </h3>
        ...
        <div className="text-center mt-20">
          <h3 className="text-3xl font-bold mb-6">
            Schedule Your Free{" "}
            <span className="text-[#7960be]">Growth Consultation</span> Today
          </h3>
