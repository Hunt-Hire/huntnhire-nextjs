...
const UnlockGrowth = () => {
  ...
  return (
    <section className="section bg-gradient-to-b from-background to-secondary/5 py-24 relative overflow-hidden bg-[linear-gradient(to_right,#ffffff12_1px,transparent_1px),linear_gradient(to_bottom,#ffffff12_1px,transparent_1px)] bg-[size:24px_24px]">
      <div className="container-custom relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-muted-foreground max-w-6xl mx-auto leading-relaxed animate-slide-up animation-delay-200">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
            {advantages.map((advantage, index) => (
              <div
                key={index}
                className="relative flex flex-col p-10 bg-background/50 
                backdrop-blur-sm rounded-2xl border border-white/10 transition-all
                 duration-300 hover:scale-[1.02] hover:shadow-[0_0_25px_rgba(121,96,190,0.25)] 
              ...
              >
                ...
                <div
                 ...
                 bg-gradient-to-b from-[#7960be] to-[#9b85de] rounded-l-2xl"
                />

                {/* Content */}
                <h4 className="text-2xl md:text-3xl font-semibold text-primary mb-7 pl-6">
                  {advantage.title}
                </h4>
                <p className="text-lg text-muted-foreground leading-relaxed pl-6 text-center">
